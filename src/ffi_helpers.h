...
static inline void _sh_ptr_write_c_uchar(char *ptr, int offset, unsigned char v) {
...
static inline void _sh_ptr_write_c_ushort(char *ptr, int offset, short unsigned int v) {
...
static inline void _sh_ptr_write_c_ulong(char *ptr, int offset, long unsigned int v) {
...
static inline void _sh_ptr_write_c_longlong(char *ptr, int offset, long long int v) {
  *(long long int *)(ptr + offset) = v;
}
static inline long long unsigned int _sh_ptr_read_c_ulonglong(char *ptr, int offset) {
  return *(long long unsigned int *)(ptr + offset);
}
static inline void _sh_ptr_write_c_ulonglong(char *ptr, int offset, long long unsigned int v) {
